...
<head>
    ...
    <title>EMA Attendance Record</title>
    <!--Material Icon-->
        ...
        <main>
            ...
            <div class="insights">
                <div class="attendance">
                    ...
                    $attendance_percentage = round(($emaTPC / ($emaTC-1)) * 100);
                    ?>

                    <div class="middle">
                        <div class="left">
                            <h3>Total Attendance</h3>
                            <h1><?php echo $emaTPC.'/'.($emaTC-1); ?></h1>
                        </div>
                        <div class="progress">
                            <svg>
...
$sql1 = "SELECT * FROM ema WHERE name = '$name'";
$sql2 = "SELECT * FROM ema WHERE name = 'Timestamp'";
