        ...
        <main>
            ...
            <div class="insights">
                <div class="attendance">
                    ...
                    $attendance_percentage = round(($physicsTPC / ($physicsTC-1)) * 100);
                    ?>

                    <div class="middle">
                        <div class="left">
                            <h3>Total Attendance</h3>
                            <h1><?php echo $physicsTPC.'/'.($physicsTC-1); ?></h1>
                        </div>
                        <div class="progress">
                            <svg>
...
$sql1 = "SELECT * FROM physics WHERE name = '$name'";
$sql2 = "SELECT * FROM physics WHERE name = 'Timestamp'";
