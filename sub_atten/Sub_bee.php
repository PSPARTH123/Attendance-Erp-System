        ...
        <main>
            ...
            <div class="insights">
                <div class="attendance">
                    ...
                    $attendance_percentage = round(($beeTPC / ($beeTC-1)) * 100);
                    ?>

                    <div class="middle">
                        <div class="left">
                            <h3>Total Attendance</h3>
                            <h1><?php echo $beeTPC.'/'.($beeTC-1); ?></h1>
                        </div>
                        <div class="progress">
                            <svg>
...
$sql1 = "SELECT * FROM bee WHERE name = '$name'";
$sql2 = "SELECT * FROM bee WHERE name = 'Timestamp'";
